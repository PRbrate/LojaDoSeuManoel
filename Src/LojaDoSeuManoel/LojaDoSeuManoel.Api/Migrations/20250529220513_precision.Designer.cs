...
namespace LojaDoSeuManoel.Api.Migrations
{
    ...
    [Migration("20250529220513_precision")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojaDoSeuManoel.Api.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LojaDoSeuManoel.Api.Entities.Requested", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Requested", "dbo");
                });

            modelBuilder.Entity("LojaDoSeuManoel.Api.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("LojaDoSeuManoel.Api.Entities.Requested", b =>
                {
                    b.HasOne("LojaDoSeuManoel.Api.Entities.User", "User")
                        .WithMany("Requesteds")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LojaDoSeuManoel.Api.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
